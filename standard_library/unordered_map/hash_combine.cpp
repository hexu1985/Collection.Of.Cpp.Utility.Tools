...
// 自定义相等比较运算符（必须为 std::unordered_map 提供）
struct ParticipantIdEqual {
    bool operator()(const ParticipantId& lhs, const ParticipantId& rhs) const {
...
void testUnorderedMap() {
    // 使用自定义哈希和相等比较器
    std::unordered_map<ParticipantId, std::string, ParticipantIdHash, ParticipantIdEqual> m_part_map;
