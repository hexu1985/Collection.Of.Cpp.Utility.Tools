...
/**
 * @file EprosimaAsyncClientTimed.cpp
 *
 */
...
{
    //std::cout << "EprosimaAsyncClientTimed::init_rpc_client" << std::endl;
...
void EprosimaAsyncClientTimed::calculate(
    ...
    mp_rpc_client->async_call_timed<Operation, Result>("operation_slow", operation, 
